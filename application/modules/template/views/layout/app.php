...
<body class="font-poppins">
    <div class="drawer">
        ...
        <aside class="drawer-side  ">
            ...
            <div class="h-screen bg-gray-100 w-60 relative">
                <ul class="menu w-full py-6 px-2">
                    <li class="active-dashboard ">
                        <a href="<?= base_url(); ?>">
                            <div class="btn-icon-dashboard animate-bounce">
                    ...
                    <li class="">
                        <a href="<?= base_url('buku/daftar-buku'); ?>">
                ...
                <div class="fixed left-4 bottom-4 px-3 py-2">
                    <a href="<?= base_url('auth/logout'); ?>" class="flex flex-nowrap">
                        ...
                        <div class="align-middle mx-4 pt-1">
                            Logout
                        </div>
                    </a>
