...
<div class="mx-4 card rounded-lg shadow-lg mb-4 border border-slate-200">
            ...
            <form action="" class="contents">
                <div class="grid grid-cols-1">
                    <div class="form-control m-4">
                        ...
                        <input type="text" name="nama_penerbit" id="nama_penerbit" placeholder="Masukkan Nama Penerbit" class="input input-sm input-bordered w-full focus:outline-none focus:border-sky-400" />
                    </div>
                    <div class="form-control m-4">
                        <label class="label" for="alamat_penerbit">
                            <span class="label-text">Alamat Penerbit</span>
                        </label>
                        <textarea class="textarea w-full focus:outline-none input-bordered focus:border-sky-400 n" placeholder="Alamat Penerbit"></textarea>
                    </div>
                    <div class="form-control m-4">
                        <label class="label" for="tlp_penerbit">
                            <span class="label-text">No Telp Penerbit</span>
                        </label>
                        <input type="text" name="tlp_penerbit" id="tlp_penerbit" placeholder="Masukkan No Telp Penerbit" class="input input-sm input-bordered w-full focus:outline-none focus:border-sky-400" />
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="p-4 mb-4">
        <button type="submit" class="btn btn-sm bg-sky-500 border-none hover:bg-sky-700 tracking-widest">Tambah Penerbit</button>
